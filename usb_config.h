...
#ifndef U2HTS_ENABLE_COMPACT_REPORT
#define U2HTS_ENABLE_COMPACT_REPORT
#endif
...
static const uint8_t config_descriptor[] = {
    ...
    2,  // bDescriptorType;
    34,
    0x00,  // for just the one descriptor
...
const static struct descriptor_list_struct {
  ...
  uint16_t length;
    ...
    {0x00002100, config_descriptor + 18,
     9},  // Not sure why, this seems to be useful for Windows + Android.
